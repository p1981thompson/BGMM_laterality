...
where $\theta = (\mu,\sigma,\phi)$ are the model parameters. We fit the model within a Bayesian framework using R and stan [@R-base;@Stan_2020], and use the model configuration from [@Egidi_2018; @Egidi_2020; see package vignette "Dealing with label Switching"]. Hence, we specify the following priors:
